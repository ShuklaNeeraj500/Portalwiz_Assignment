...
const Role_comp =()=>{
    ...
    const Column = [
      { title: 'ID', field: 'role_id',sorting:false, searchable:false },
      { title: 'Role Profile', field: 'role_profile' },
    ]
...
// ------------------------Fetching Role table data-------------------------------------
    useEffect(() => {
      ...
      const loadRoles =  () =>{
       ...
       axios.post("http://sandbox.portalwiz.com/php/roles.php", obj)
        .then( (response) => {
    ...
    <div className="container-fluid">
        ...
        <div className="container">
            ...
            <div className="col-11 mx-auto d-flex justify-content-end">
                <Link to="/add-role" className="btn btn-primary btn_link">Add Roles <Add  /></Link>
            </div>
            </div>
                <div className="row ">
                   <div className="col-11 mx-auto">
                        ...
                        <MaterialTable
                          ...
                          onRowClick={
                              (event,rowData)=>{
                                console.log(rowData)
                                history.push("/view-role/" + rowData.role_id)
                              }
                          }
                        />
                        </MuiThemeProvider>
