 ...
 return(
    ...
    <div className="container-fluid  ">
        ...
        <ol className="breadcrumb Breadcrumb align-items-center">
                ...
                <li className="breadcrumb-item active" aria-current="page">Edit User Preferences</li>
            </ol>
        </nav> 

        <Heading name="Edit User Preference" />
...
export default Edit_preference_comp