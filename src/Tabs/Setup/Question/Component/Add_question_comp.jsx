...
/*---------------Creating object to send data through Axios------------------------- */
        const obj = {
            created_by :state.uname , created_date:newdate, uname:sessionStorage.getItem("username"),
        ...
        axios.post("http://sandbox.portalwiz.com/php/questions/add_questions.php", obj)
        .then( (res) => {console.log(res)
            if(res.data.message === "Question Created successfully."){
                ...
                <div className="col-11 col-md-6 mx-auto">
                    ...
                    <h5 className="mb-4">Add Question</h5>
                        ...
                        <div className="col-11 col-md-6 mx-auto">
                           ...
                           {/* <div className="form-group row">
                            ...
                            <div className="col-sm-7 col-md-6 ">
                                <select className="custom-select form-control" name="location_name" onChange={onChange} defaultValue={state.location_name}>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-7 col-md-6 ">
                                <select className="custom-select form-control" name="level_name" onChange={onChange} defaultValue={state.level_name}>
                                <option selected>Choose</option>
...
export default Add_question_comp